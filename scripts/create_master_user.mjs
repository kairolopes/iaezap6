...
async function getMasterCompany() {
  ...
  // If no master company exists, create one
  console.log('✗ No master company found. Creating one...');

  // We need an owner_id to create a company. For the initial master user,
  // we'll use a temporary UUID and update it later
...
async function main() {
  try {
    console.log('========================================');
    console.log('Creating Master User in Supabase');
    console.log('========================================');
